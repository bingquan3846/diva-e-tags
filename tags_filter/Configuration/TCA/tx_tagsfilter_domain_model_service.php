...
return [
    ...
    'types' => [
        '1' => ['showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, title ,teaser, shortdescription, pics, description, advantages, label, ordering, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime, --div--; Tags, tags,--div--;Categories, categories, --div--; Colleges, colleges, --div--; Seo Keywords, keywords'],
   ],
    'palettes' => [
        '1' => ['showitem' => ''],
   ],
    'columns' => [
        ...
        'advantages' =>  [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND 1=1 Order by tx_tagsfilter_domain_model_advantage.title ASC',
        ...
        'ordering' => [
            'label' => 'Ordering of other services and more ',
            'config' => [
                'type' => 'radio',
                'default' => '0',
                'items'   => [
