...
{
    /**
     * @var \Divae\DivaeLocationManager\Controller\LocationController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Divae\DivaeLocationManager\Controller\LocationController::class)
